...
const TW = $persistentStore.read('BiliArea_TW') || 'TW-Point'; //Your Taiwan sub-policy name.
const HK = $persistentStore.read('BiliArea_HK') || 'HK-Point'; //Your HongKong sub-policy name.
